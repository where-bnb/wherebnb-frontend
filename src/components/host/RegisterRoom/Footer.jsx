...
const Footer = (url) => {
  ...
  return (
    <footer className="sticky bottom-0 bg-white border-t-2 border-gray-200 px-6 py-4 flex justify-between items-center">
      {/* 여기에 추가적인 컨텐츠나 로고를 넣을 수 있습니다. */}
      <div></div>

      <div className="flex justify-end">
        <Button label="다음" onClick={handleButtonClick} />
      </div>
    </footer>
  );
};
